class AppStrings {
  ...
  static const String onboardingText2 =
      "Turn your plans into reality stay focused.";
  static const String onboardingText3 =
      "Every step forward brings you closer to success";
  //// OnBoarding Image Path /////
  static const String onboardingImagePlan = "assets/images/planing.png";
  static const String onboardingImageComplete = "assets/images/complete.png";
